...
Selectivity.Locale = {
    ...
    noResults: $.i18n.t('PluginEditor.device_editor.no_device_result'),
//            'No results found',
    noResultsForTerm: function(term) { 
//        return 'No results for <b>' + escape(term) + '</b>'; 
        return $.i18n.t('PluginEditor.device_editor.no_device_result') + '<b>' + escape(term) + '</b>'; 
    }
...
Selectivity.Templates = {
    ...
    singleSelectInput: (
        '<div class="selectivity-single-select">' +
            '<input type="text" class="selectivity-single-select-input" style="width: 100%;">' +
