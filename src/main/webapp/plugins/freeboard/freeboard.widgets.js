...
/**
 * 這個大包的widget已停用啦，這裡不支援i18n
 * comment by ken 2015/10/13
 * */
(function () {

    //added by ken 20140924
    var freeboardWidgetsLog = log4jq.getLogger({
        loggerName: 'freeboard.widges.js'
    });
    freeboardWidgetsLog.info('start to init freeboard widgets');
    ...
    var textWidget = function (settings) {
        ...
        freeboardWidgetsLog.info('textWidget init');
        var self = this;
        ...
        this.render = function (element) {
            freeboardWidgetsLog.info('textWidget render');
            $(element).empty();
        ...
        this.onSettingsChanged = function (newSettings) {
            freeboardWidgetsLog.info('textWidget onSettingsChanged');
        ...
        this.onCalculatedValueChanged = function (settingName, newValue) {
            freeboardWidgetsLog.info('textWidget onCalculatedValueChanged');
        ...
        this.getHeight = function () {
            freeboardWidgetsLog.info('textWidget getHeight');
    ...
    freeboard.loadWidgetPlugin({
        ...
        display_name: "Text",
        "external_scripts": [
            "js/libs/jqplugins/FreeBoard/plugins/thirdparty/jquery.sparkline.min.js"
        ],
        settings: [
            {
                name: "title",
    ...
    freeboard.loadWidgetPlugin({
        ...
        display_name: "Gauge",
        "external_scripts": [
            "js/libs/jqplugins/FreeBoard/plugins/thirdparty/raphael.2.1.0.min.js",
            "js/libs/jqplugins/FreeBoard/plugins/thirdparty/justgage.1.0.1.js"
        ],
        settings: [
            {
                name: "title",
