...
//                        $.i18n.t('plugins_wd.picture.src_desc')
            },
            {
                name: 'refresh',
                display_name: $.i18n.t('global.refresh'),
//                        $.i18n.t('plugins_wd.picture.refresh'),
                validate: 'optional,custom[integer],min[1]',
                type: 'number',
                style: 'width:100px',
                suffix: $.i18n.t('global.refresh_suffix'),
//                        $.i18n.t('plugins_wd.picture.refresh_suffix'),
                description: 
                        $.i18n.t('plugins_wd.picture.refresh_desc')
            }
        ],
