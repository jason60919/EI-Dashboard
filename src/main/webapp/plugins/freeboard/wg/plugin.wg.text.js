...
(function () {
    ...
    var logger = log4jq.getLogger({
        loggerName: 'plugin.wg.text.js'
    });

    logger.info('plugin.wg.text.js loaded');
    ...
    var textWidget = function (settings) {
        ...
        function getText(value) {
            logger.info('getText: ' + value);

            var text;
            if (_.isNumber(value)) {
                logger.debug('value is number');
                ...
                text = value;
                logger.debug('value is Not number: ' + text);
            }
            return text;
        }
                    ...
                    case 'area':
                        ...
                        d3var.gChart.selectAll('.spot')
                                .attr('cx', function (d, i) {
                                    return d3var.chart.xScale(i);
                                })
                                .attr('cy', function (d, i) {
                                    return d3var.chart.yScale(d);
                                });
                        break;
                    case 'bar':
                        ...
                        d3var.gChart.selectAll('.bar')
                                ...
                                .attr('y', function (d, i) {
                                    return d < 0 ? d3var.chart.yScale(0) : d3var.chart.yScale(d);
                                })
                                .attr('height', function (d, i) {
                                    return Math.abs(d3var.chart.yScale(d) - d3var.chart.yScale(0));
                                });
                        break;
                }
            }
        ...
        function updateTooltip(x) {
            ...
            d3var.gChart.gTooltip.html(getText(val) + ' ' + unit)
                    .style('left', (d3.event.pageX + 10) + 'px')
                    .style('top', (d3.event.pageY + 70 - $('.gridster').offset().top) + 'px');
            //.style('top', (d3.event.pageY - 28 - $('.gridster').offset().top) + 'px');
        ...
        function lineAreaChartTransition(min, max) {
            logger.info('lineAreaChartTransition min:' + min + ', max:' + max);
        ...
        function barChartTransition(min, max) {
            ...
            d3var.gChart.selectAll('.bar')
                    ...
                    .on('mousemove', function () {
                        updateTooltip(d3.mouse(this)[0]);
                    })
                    .on('mouseover', function () {
                        showTooltip(d3.mouse(this)[0]);
                    })
                    .on('mouseout', function () {
                        hideTooltip();
                    });
        ...
        function chartTransition(val) {
            logger.info('chartTransition: ' + val);
        ...
        function refresh(value) {
            logger.info('refresh: ' + value);

            var valueType = typeof (value);
            logger.debug('valueType: ' + valueType);
            if (value != 'undefined' && valueType != 'undefined' && valueType != 'object Object' && valueType.toLowerCase() != 'object') {
                ...
                logger.warn('Invalid refresh value');
...
//            logger.debug(' option.chart.type: ' +  option.chart.type);
//            logger.debug(' newSettings.chart_type: ' +  newSettings.chart_type);
...
//                        $.i18n.t('plugins_wd.text.comma'),
                ...
                },
                {
                    ...
                    //$.i18n.t('plugins_wd.text.chart_type'),
                    type: 'option',
                    options: [
                        {
...
//                                $.i18n.t('plugins_wd.text.chart_type_options.bar'),
                ...
                },
                {
                    ...
                    addClass: 'advancedSetting'
//                            $.i18n.t('plugins_wd.text.chart_color_desc')
                },
                {
                    ...
                    description: $.i18n.t('global.plugins_wd.default_color', '#0496ff'),
                    addClass: 'advancedSetting'
//                            $.i18n.t('plugins_wd.text.chart_minmax_color_desc')
                },
                {
                    name: "height",
    ...
    freeboard.loadWidgetPlugin({
        ...
        settings: textWidgetPluginConfig,
